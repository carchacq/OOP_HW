...
katya = Student('Екатерина', 'Синицына', 'female')
...
ivanovich = Reviewer('Иван Иванович', 'Гусятников')
ivanovich.courses_attached += ['Python']

petrovich = Reviewer('Петр Петрович', 'Курочкин')
petrovich.courses_attached += ['Git']

eduard = Lecturer('Эдуард', 'Соколовский')
eduard.courses_attached += ['Python']

veniamin = Lecturer('Вениамин', 'Коршаков')
